app.component('flight-table',{
    ...
    <div class="table">
        ...
        <div v-if = "callsign.length===0"> 
            <h3 v-if = "enLang">Sorry, but you must Tap/click at "back to home" on the top-left to go to index page. And begin to search flights again.</h3>
            <h3 v-else>ขออภัย แต่ตุณต้องเลือกเมนู "กลับหน้าหลัก" ทางซ้ายบนของหน้าเว็บ เพื่อกลับไปยังหน้าเริ่มต้น และทำการค้นหาเที่ยวบินใหม่อีกครั้ง</h3>
        </div>
        <div class = "info">
            <div class = "callsign" >
